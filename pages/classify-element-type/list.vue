      ...
      <unicloud-db ref="udb" :collection="collectionList" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'icon')">分类logo</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/classify-element-type.js';
  ...
  export default {
    data() {
      return {
        collectionList: [ db.collection('classify-element-type').field('title,sort,categoriesType,icon,status').getTemp(),db.collection('classify-categories-type').field('_id, title as text').getTemp() ],
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "classify-element-type.xls",
          "type": "xls",
          "fields": {
            "标题": "title",
            "序号": "sort",
