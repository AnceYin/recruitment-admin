<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="title,sort,status" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/classify-categories-type.js';
  ...
  export default {
    data() {
      return {
        collectionList: "classify-categories-type",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "classify-categories-type.xls",
          "type": "xls",
          "fields": {
            "标题": "title",
            "序号": "sort",
